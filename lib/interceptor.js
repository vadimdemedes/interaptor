...
var Interceptor = (function (_EventEmitter) {
  ...
  Interceptor.prototype.times = function times(n) {
    this._times = n;
  ...
  Interceptor.prototype.disable = function disable() {
    ...
    this._interaptor.interceptors = this._interaptor.interceptors.filter(function (interceptor) {
  ...
  Interceptor.prototype._handleRequest = function _handleRequest(req, res) {
    ...
    fetchBody(req, function (err, body) {
      ...
      // disable itself
      if (--_this2._times <= 0) _this2.disable();
    });
  };
  ...
  Interceptor.prototype._respondRequest = function _respondRequest(req, res) {
    ...
    Object.keys(this._headers).forEach(function (name) {
      var value = _this4._headers[name];
