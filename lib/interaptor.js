...
var Interaptor = (function () {
  ...
  Interaptor.find = function find(req) {
    ...
    var interceptors = this.interceptors.filter(function (interceptor) {
      ...
      var methodMatches = interceptor.method ? interceptor.method === method : true;
      var hostMatches = interceptor.host ? interceptor.host === host : true;
      var pathMatches = interceptor.path ? interceptor.path === path : true;
